...
class ReservationServiceImplDBTest {
    ...
    void makeReservationTestRoomConflicts() throws Exception {
        ...
        assertThrows(ForbiddenException.class, () -> reservationServiceImpl.makeReservation(3, 6, "Title",
                "2022-01-15T15:29", "2022-01-15T15:30"));

        // between 14:15 and 15:00 in room 4, should conflict
        assertThrows(ForbiddenException.class, () -> reservationServiceImpl.makeReservation(4, 7, "Title",
                "2022-01-15T14:15", "2022-01-15T15:00"));
    }
